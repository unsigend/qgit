...
extern int commit_parse(struct object *obj);
extern struct object *commit_create(const struct commit *commit);
extern void commit_close(struct commit *commit);
extern int commit_fprintf(struct object *obj, FILE *fp);
extern int commit_fprintf_style(struct object *obj, FILE *fp,
...
extern struct object *commit_iter_get(struct commit_iter *iter);
