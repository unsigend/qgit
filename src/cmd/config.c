...
//     from
//             the global or local config file, if auto, get the value from
//             local config first, then from global config if not found.

//     --set:  if --global or --local is specified, set the value of the key in
//     the
//             global or local config file, if auto, set the value in local
//             config.

//     --unset: if --global or --local is specified, unset the value of the key
//     in
//             the global or local config file, if auto, unset the value in
//             local config.
// */
